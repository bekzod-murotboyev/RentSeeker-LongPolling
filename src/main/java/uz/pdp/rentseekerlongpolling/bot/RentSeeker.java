    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage()) {
            ...
            switch (update.getCallbackQuery().getData()) {
                ...
                case ADMIN :  state = BotState.ADMIN_PANEL;break;
                case SETTINGS: case  BACK_TO_SETTINGS_MENU_EDIT :  state = BotState.SETTINGS_MENU_EDIT;break;
                case BACK_TO_ADMIN_MENU :  state = BotState.ADMIN_MENU_EDIT;break;
                case BACK_TO_SETTINGS_MENU_SEND :  state = BotState.SETTINGS_MENU_SEND;break;
                case BACK_TO_MAIN_MENU_SEND :  state = BotState.MAIN_MENU_SEND;break;
                case BACK_TO_MAIN_MENU_EDIT: case  USER :  state = BotState.MAIN_MENU_EDIT;break;
                case CHANGE_LANGUAGE :  state = BotState.CHANGE_LANGUAGE;break;
                case REGISTRATION :  state = BotState.REGISTER;break;
                case ADD_ACCOMMODATION: case  BACK_TO_GIVE_HOME_STATUS :  state = BotState.GIVE_HOME_STATUS;break;
                case BACK_TO_WRITE_SEND_LOCATION: case  FOR_RENTING: case  FOR_SELLING :  state = BotState.WRITE_OR_SEND_LOCATION;break;
                case BACK_SEND_LOCATION: case  SEND_LOCATION :  state = BotState.LOCATION_MENU;break;
                case BACK_TO_GIVE_REGION: case  WRITE_ADDRESS :  state = BotState.GIVE_REGION;break;
                case BACK_TO_GIVE_DISTRICT :  state = BotState.GIVE_DISTRICT;break;
                case BACK_TO_GIVE_ADDRESS :  state = BotState.GIVE_ADDRESS;break;
                case BACK_TO_GIVE_HOME_TYPE :  state = BotState.GIVE_HOME_TYPE_EDIT;break;
                case BACK_TO_GIVE_HOME_NUMBER :  state = BotState.GIVE_HOME_NUMBER;break;
                case BACK_TO_GIVE_HOME_AREA :  state = BotState.GIVE_HOME_AREA_EDIT;break;
                case BACK_TO_GIVE_HOME_PHOTO :  state = BotState.GIVE_HOME_PHOTO_EDIT;break;
                case BACK_TO_GIVE_HOME_PRICE :  state = BotState.GIVE_HOME_PRICE_EDIT;break;
                case BACK_TO_SHOW_MENU_EDIT: case  SHOW_ACCOMMODATIONS :  state = BotState.SHOW_MENU_EDIT;break;
                case BACK_TO_SHOW_MENU_SEND :  state = BotState.SHOW_MENU_SEND;break;
                case SHOW_ALL: case  PREV: case  NEXT :  state = BotState.SHOW_OPTIONS;break;
                case BACK_TO_CHOOSE_REGION: case  SEARCH :  state = BotState.CHOOSE_REGION;break;
                case BACK_TO_CHOOSE_DISTRICT :  state = BotState.CHOOSE_DISTRICT;break;
                case BACK_TO_CHOOSE_HOME_STATUS :  state = BotState.CHOOSE_HOME_STATUS;break;
                case BACK_TO_CHOOSE_HOME_TYPE: case  GET_RENTING: case  FOR_BUY :  state = BotState.CHOOSE_HOME_TYPE;break;
                case BACK_TO_CHOOSE_HOME_NUMBER :  state = BotState.CHOOSE_HOME_NUMBER_EDIT;break;
                case BACK_TO_CHOOSE_MIN_PRICE :  state = BotState.CHOOSE_HOME_MIN_PRICE_EDIT;break;
                case BACK_TO_CHOOSE_MAX_PRICE_SEND :  state = BotState.CHOOSE_HOME_MAX_PRICE_SEND;break;
                case BACK_TO_CHOOSE_MAX_PRICE_EDIT :  state = BotState.CHOOSE_HOME_MAX_PRICE_EDIT;break;
                case BACK_TO_MY_NOTES_MENU_EDIT: case  MY_NOTES :  state = BotState.MY_NOTES_MENU_EDIT;break;
                case BACK_TO_MY_NOTES_MENU_SEND :  state = BotState.MY_NOTES_MENU_SEND;break;
                case MY_FAVOURITES :  state = BotState.MY_FAVOURITES;break;
                case MY_ACCOMMODATIONS :  state = BotState.MY_HOMES;break;
                case SKIP :  state = botService.getStateBySkip(update, state);break;
        ...
        switch (state) {
            case CHOOSE_LANGUAGE :  execute(botService.chooseLanguage(update, lan));break;
            case CHECK_USER_BY_ADMIN :  execute(botService.checkUserMenu(update, lan));break;
            ...
            case CHANGE_LANGUAGE :  execute(botService.changeLanguage(update, lan));break;
            case MAIN_MENU_EDIT :  execute(botService.setMenuEdit(update, lan, role));break;
            case MAIN_MENU_SEND :  execute(botService.setMenuSend(update, lan, role));break;
            case SETTINGS_MENU_EDIT :  execute(botService.getSettingMenuEdit(update, lan));break;
            ...
            case GIVE_REGION :  execute(botService.giveRegionMenu(update, lan));break;
            case GIVE_DISTRICT :  execute(botService.giveDistrictMenu(update, lan, state));break;
            case GIVE_ADDRESS :  execute(botService.giveAddressMenu(update, lan, state));break;
            ...
            case GIVE_HOME_TYPE_EDIT :  execute(botService.giveHomeTypeMenuEdit(update, lan));break;
            case GIVE_HOME_NUMBER :  execute(botService.giveHomeNumberMenu(update, lan, state));break;
            ...
            case GIVE_HOME_AREA_EDIT :  execute(botService.giveHomeAreaMenuEdit(update, lan));break;
            ...
            case GIVE_HOME_PHOTO_EDIT :  execute(botService.giveHomePhotoMenuEdit(update, lan));break;
            case GIVE_HOME_PRICE_SEND :  execute(botService.giveHomePriceMenuSend(update, lan, state));break;
            case GIVE_HOME_PRICE_EDIT :  execute(botService.giveHomePriceMenuEdit(update, lan));break;
            ...
            case SHOW_MENU_SEND :  execute(botService.getShowMenuSend(update, lan));break;
            case SHOW_MENU_EDIT :  execute(botService.getShowMenuEdit(update, lan));break;
            case SHOW_OPTIONS :  {
            ...
            case CHOOSE_REGION :  execute(botService.chooseRegionMenu(update, lan));break;
            case CHOOSE_DISTRICT :  execute(botService.chooseDistrict(update, lan));break;
            case CHOOSE_HOME_STATUS :  execute(botService.chooseHomeStatus(update, lan));break;
            case CHOOSE_HOME_TYPE :  execute(botService.chooseHomeType(update, lan));break;
            case CHOOSE_HOME_NUMBER_EDIT :  execute(botService.chooseHomeNumberEdit(update, lan));break;
            ...
            case CHOOSE_HOME_MIN_PRICE_EDIT :  execute(botService.chooseMinPriceMenuEdit(update, lan));break;
            ...
            case CHOOSE_HOME_MAX_PRICE_EDIT :  execute(botService.chooseMaxPriceMenuEdit(update, lan));break;
            ...
            case MY_NOTES_MENU_EDIT :  execute(botService.getMyNotesMenuEdit(update, lan));break;
            case MY_NOTES_MENU_SEND :  execute(botService.getMyNotesMenuSend(update, lan));break;
            case MY_FAVOURITES :  {
                execute(botService.deleteMessage(update));
            ...
            case DELETE_ACCOMMODATION :  execute(botService.deleteAccommodation(update));break;
    ...
    public void onUpdateReceivedForAdmin(Update update,LanStateDTO data) {
        ...
        if (update.hasMessage()) {
            ...
            switch (update.getCallbackQuery().getData()) {
                ...
                case ADMIN_DEACTIVATED_USERS:
                    ...
                    break;
                case SEARCH:
                    state = ADMIN_USER_ENTER_PHONE_NUMBER;
                    break;
        ...
        switch (state) {
            ...
            case ADMIN_MAIN_MENU_SEND:
                execute(adminBotService.setAdminMenuSend(update, lan));break;
            case ADMIN_MAIN_MENU_EDIT:
                execute(adminBotService.setAdminMenuEdit(update, lan));break;
            case ADMIN_USERS_SHOW:
                execute(adminBotService.setAdminShowUsersEdit(update, lan));break;
            case ADMIN_CHOOSE_USER_TYPE_SEND:
                execute(adminBotService.setAdminChooseUsersSend(update, lan));break;
            case ADMIN_CHOOSE_USER_TYPE_EDIT:
                execute(adminBotService.setAdminChooseUsersEdit(update, lan));break;
            case ADMIN_USER_ENTER_PHONE_NUMBER:
                execute(adminBotService.setAdminUserEnterPhoneEdit(update, lan));break;
            case ADMIN_HOMES_FILTER_SEND:
                execute(adminBotService.setAdminHomeFilterSend(update, lan));break;
            case ADMIN_HOMES_FILTER_EDIT:
                execute(adminBotService.setAdminHomeFilterEdit(update, lan));break;
            case ADMIN_SEARCH_USER_INFO_SEND:
                execute(adminBotService.sendAdminUserInfo(update, lan));break;
            case ADMIN_SEARCH_USER_INFO_EDIT:
                execute(adminBotService.editAdminUserInfo(update, lan));break;
            ...
            case ADMIN_HOMES_INFO: {execute(adminBotService.sendAdminDeleteHome(update, lan));break;}
            default:
                execute(botService.setError(update));
        }
